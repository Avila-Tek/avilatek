      ...
      <main>
        ...
        <section className="relative w-full bg-light-blue dark:bg-dark-gray flex flex-col items-center pt-32 md:pt-44 transition duration-300 ease-in-out">
          <div className="flex flex-col items-center px-14 sm:px-10 text-center z-10">
            <h3 className="text-sm md:text-base xl:text-lg text-secondary-50 dark:text-primary-100 font-semibold mb-2">
              {category}
            </h3>
            <h1 className="w-full sm:w-11/12 lg:w-10/12 font-bold text-xl md:text-2xl xl:text-3xl">
              {title}
            </h1>
          </div>
        ...
        {/* Post */}
        <section className="w-9/12 md:w-7/12 mx-auto mt-8 md:mt-0 lg:-mt-10 xl:-mt-24 mb-40">
          {/* Post header */}
          <div>
