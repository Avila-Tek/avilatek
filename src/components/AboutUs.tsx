...
export default function AboutUs() {
  return (
    <section id="about-us" className="pt-48 -mt-48 pb-60 w-full relative z-10 overflow-hidden">
      <div>
        <div className="flex flex-col md:flex-row justify-center items-center gap-6 md:gap-16 xl:gap-20 px-8 md:px-10 lg:px-20">
          {/* Coding illustation */}
      ...
      <div className="absolute top-28 left-1/4 rounded-blob w-80 h-96 brick bg-medium-blue bg-opacity-90" />
      <div className="absolute bottom-28 right-1/4 rounded-second-blob w-80 md:w-6/12 h-72 md:h-80 brick bg-medium-blue bg-opacity-90" />
    </section>
  );
}
