...
export default function ProjectCard({
  ...
  return (
    ...
    >
      ...
      <div className="w-full h-full absolute top-0 left-0 p-6 lg:p-8 bg-primary-50 dark:bg-primary-500 bg-opacity-90 dark:bg-opacity-80 flex flex-col justify-between opacity-0 group-hover:opacity-100 duration-500 transition-all ease-in-out">
        <div>
