...
export default function PortfolioSection() {
  return (
    <section className="mt-40 mb-56 w-full">
      ...
      <button
        type="button"
        className="text-primary-500 bg-transparent border-2 border-primary-500 hover:border-primary-400 hover:text-primary-400 py-1.5 px-6 rounded-full focus:outline-none active:border-primary-300 active:text-primary-300"
      >
