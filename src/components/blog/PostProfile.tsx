      ...
      <section className="w-9/12 md:w-7/12 mx-auto mt-8 mb-40">
        ...
        <div>
          <h2 className="font-semibold text-base md:text-lg text-secondary-100 dark:text-neutral-100">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Enim arcu,
            nunc consectetur tincidunt. Amet, et at nunc dolor
          </h2>
        ...
        <div className="grid gap-5 text-sm lg:text-base">
          ...
          <p>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Enim arcu,
            nunc consectetur tincidunt. Amet, et at nunc dolor. Sed a amet fusce
            ut dolor, nulla faucibus. Purus at enim nulla diam id bibendum.
            Donec curabitur sed senectus consectetur tristique odio viverra.
            Erat blandit vitae vitae, vitae dolor in eu amet, nisl. Massa ornare
            feugiat nascetur nec pellentesque egestas enim a. Tellus curabitur
            sed volutpat velit vulputate tincidunt. Volutpat ultricies mattis
            fringilla dignissim. Consequat nisl aliquam sit et pulvinar nibh
            cras. Pulvinar molestie vestibulum eget et odio. Eu tristique lectus
            nec pharetra, diam fames. Eget urna nunc condimentum integer nunc
            enim. Convallis fringilla ipsum in tellus tempus, eu elementum.
          </p>
          <p>
            ...
            Vel, adipiscing hendrerit ipsum vel, nisi ac velit sed pellentesque.
            Mattis dictumst arcu tempus morbi. Sit nulla lectus mattis quis
            tellus urna.
          </p>
          <p>
            Lacinia sit est non, in leo, pellentesque. Pellentesque aliquam mi,
            ultricies mi. Ornare mi eget magna sit ut sed tellus. Turpis
            ...
            adipiscing quam viverra pellentesque. Proin curabitur porta viverra
            sit nunc.
          </p>
        </div>
        <hr className="my-12 border border-dark-blue dark:border-dark-gray" />
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="w-11/12 md:w-9/12">
            ...
            <p className="mt-2 text-xsm lg:text-sm">
              ...
              porta sed facilisis posuere imperdiet.
            </p>
          </div>
        </div>
      </section>
