...
export default function ServiceSection() {
  ...
  return (
    <section id="services" className="pt-20 md:pt-56 -mt-20 md:-mt-56 w-full mb-96 flex flex-col md:flex-row gap-20 xl:gap-28 px-14 lg:px-24 items-center justify-center">
