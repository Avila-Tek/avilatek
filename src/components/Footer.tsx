...
export default function Footer() {
  return (
    <footer className="bg-light-blue dark:bg-medium-gray w-full px-10 lg:px-20 py-2 shadow-blue border-t-2 border-medium-blue dark:border-dark-gray dark:text-font-white">
      ...
      <div className="relative w-full">
        <svg
          className="h-32 w-32 text-medium-blue dark:text-dark-gray absolute right-3"
          style={{ top: '-7rem' }}
          viewBox="0 0 176 5"
      ...
      <hr className="w-full mb-4 mt-2 border-medium-blue dark:border-dark-gray" />
