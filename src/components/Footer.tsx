...
export default function Footer({ language = 'es' }: FooterProps) {
  return (
    <footer className="bg-light-blue dark:bg-medium-gray w-full px-12 lg:px-24 xl:px-26 py-4 shadow-blue dark:shadow-dark-gray border-t-2 border-medium-blue dark:border-dark-gray dark:text-font-white transition-all duration-300 ease-in-out">
      ...
      <div className="relative w-full">
        <svg
          className="h-32 w-32 text-medium-blue dark:text-dark-gray dark:text-opacity-50 absolute right-1 sm:right-3 -top-24 sm:-top-28 transition-all duration-300 ease-in-out"
          viewBox="0 0 176 5"
      ...
      <hr className="w-full mb-4 mt-6 sm:mt-3 border-medium-blue dark:border-dark-gray dark:border-opacity-50" />
      <div className="w-full flex items-center justify-between text-xs lg:text-sm my-0.5">
        <p>
